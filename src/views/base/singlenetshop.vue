          ...
          <el-row :gutter="20">
            <el-col :span="16">
              <el-form-item label="网上商家名称：" required>
                <el-input v-model="currentBizInfo.com_name" placeholder="请输入网上商家名称"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          ...
          <el-row :gutter="20">
            <el-col :span="8">
              <el-form-item label="联系人员：">
                <el-input v-model="currentBizInfo.com_contact" placeholder="请输入网上商家联系人姓名"></el-input>
              </el-form-item>
            </el-col>

            <el-col :span="8">
              <el-form-item label="联系电话：">
                <el-input v-model="currentBizInfo.com_contactphone" placeholder="请输入网上商家联系人电话"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          ...
          <el-row :gutter="20">
            <el-col :span="8">
              <el-form-item label="固定电话：">
                <el-input v-model="currentBizInfo.com_tel" placeholder="请输入网上商家的固定电话"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
