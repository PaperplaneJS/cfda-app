      ...
      <table>
        ...
        <tr>
          <td class="content" colspan="4">
            <p>检查内容：</p>
            <p>江苏省苏州市常熟市{{currentReport.biz.grid}}食品药品监督管理局检查人员{{currentReport.staff}}根据《中华人民共和国食品安全法》及其实施条例、《食品生产经营日常监督检查管理办法》的规定，于{{currentReport.date}}对你单位进行了监督检查。本次监督检查按照表{{currentReport.checkContent}}开展，共检查了{{getResult.count}}项内容。其中:
            </p>
            <p>
